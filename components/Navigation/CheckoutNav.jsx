...
const CheckoutNav = () => {
  return (
    <div className="z-[100] h-14  w-full ml-[5px] grid items-center pb-4 pt-4 borderb md:ml-[25px]">
      <div className="justify-self-center md:justify-self-start col-start-1 row-start-1">
        <Link href={"/"}>
          <a href="">
